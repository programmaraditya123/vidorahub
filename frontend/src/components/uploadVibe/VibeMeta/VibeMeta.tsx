...
export default function VibeMeta({ uploader }: Props) {
  ...
  // Load follow status once auth is ready
  useEffect(() => {
    ...
    <>
      <div className={styles.vibeMeta}>
        <div className={styles.left}>
          <img
            src={uploader.profilePicture || getFallbackAvatar(uploader.name)}
            alt="profile"
        ...
        <button
          className={`${styles.subscribeBtn} ${following ? styles.subscribed : ""}`}
