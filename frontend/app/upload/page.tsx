      ...
      <div className={styles.overlay}>
        <div className={`${styles.modal} glass-dark`}>
          ...
          <div className={styles.options}>
            <Link href="/uploadvideo" className={`${styles.card} neon-glow`}>
              <span className="material-symbols-outlined">movie</span>
              <h3>Video</h3>
            </Link>

            <Link href="/uploadvibe" className={`${styles.card} neon-glow`}>
          ...
          <p className={styles.note}>
            ...
            For longer content, please upload using <strong>Video</strong>.
          </p>
        </div>
      </div>
    </>
